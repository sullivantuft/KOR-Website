...
login.addEventListener("submit", (e) => {
    ...
    fetch("https://jmrcycling.com:3001/loginShop", requestOptions)
        ...
        .then(result => {
            ...
            window.location.replace("https://jmrcycling.com/shop_tools/dashboard?plan_type=" + result.plan_type[0].plan_type + "&shop_name=" + result.plan_type[0].shop_name + "&token=" + result.plan_type[0].token);
